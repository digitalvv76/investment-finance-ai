...
| | V1 | V2 |
|---|:---:|:---:|
| **工作目录** | `D:\class1\.claude\worktrees\v1-stable` | `D:\class1` |
| **Git 分支** | `v1-stable` | `main` |
| **角色** | 用户的投资助手 | 用户的技术工程师 |
| **实例** | 和 V2 一样，都是 Claude | 和 V1 一样，都是 Claude |

**我们两个都是 AI，为同一个用户服务。** 区别不是「人 vs AI」，而是「业务窗口 vs 技术窗口」。

> ⚠️ 之前 V2 错写成「V1 已回归 main」——这是误读。SESSION.md 那句话指 v1-stable 分支在 7/11 被 reset 对齐了 main，**不是说 V1 搬到了 main 目录**。V1 始终在 v1-stable 工作树。详见 `worktree-setup` 记忆。
