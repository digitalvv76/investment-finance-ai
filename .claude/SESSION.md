...
## 📋 下一步 / 待办
0c. **🆕 V2 待办（2026-07-11 交接，决策已锁）**：`SPEC-intensity-scale-bear-bias.md` —— intensity 强度标尺**利好偏置**：利空事件无对应档，只能往"5=板块暴涨"顶格硬套 → 生产实测 news_id=3612(cal-01) 被误拉 CRITICAL 手机警笛。修：强度改方向中性"波动剧烈程度"+显式利空档。**渠道决策=B（已拍板）**：利空手机上限 important；仅当「命中持仓/关注股 **且** 已确认(非传闻)」才升级警笛。⚠️坑：GOOGL 在关注股内，cal-01 靠"传闻不升级"挡住不回 critical。验收锚点：cal-01 改后不得判 critical。校准素材 `catalyst-cases-negative.jsonl` 已备。归属 main/V2。已 push origin/v1-stable。
