...
> 最后更新: 2026-07-17。推送门槛 + 流程改进已部署。

## 🟢 当前部署状态
- **ECS 生产**: V2 (origin/main, `994503c`)，健康 ✅
...
## 📋 下一步（按优先级）
1. **[P0]** 观察推送频率变化 — 验证新阈值效果 (部署后 24h TG 通知带计数)
2. **[P1]** OpenD systemd 重启循环修复 — cron 已排期，确认是否生效
3. **[P2]** ATR 波动率阈值 + 因子有效性回测

## 📋 暂缓
- Playwright/Twitter/WebScraper 浏览器 OOM（P3，观察中）
